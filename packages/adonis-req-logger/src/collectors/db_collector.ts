import { hrtimeToMs } from '../log_request.js'
import { requestStorage } from '../request_store.js'
import type { ResolvedReqLoggerConfig } from '../types.js'

/**
 * Shape of Lucid's `db:query` event payload, declared structurally so the
 * package works without `@adonisjs/lucid` installed
 */
